...
public class Game_looper
{
	...
	public Game_looper(Room data_in, int fps, Game_output out)
	{
	...
	public void setData(Room data_in)
	{
		root_container = data_in;
	}
	...
	{	
		...
		{			
			...
			Graphics g = frame_image.getGraphics();
