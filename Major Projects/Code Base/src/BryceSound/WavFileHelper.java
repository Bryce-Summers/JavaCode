...
/**
 * This code was retrieved from http://stackoverflow.com/questions/10397272/wav-file-convert-to-byte-array-in-java.
 * 
...
public class WavFileHelper {    
    ...
    public static void main(String[] args) {
        ...
        String inputFile = "Toad_Clip.wav"; // Place the wav file in the top level directory, ie S:/input.wav
